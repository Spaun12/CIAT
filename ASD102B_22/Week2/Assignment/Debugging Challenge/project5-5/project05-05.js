...
function scrambleTiles() {
  for (let i = 0; i < allTiles.length; i++) { // Changed <= to <
...
function playConcentration() {
  ...
  for (let i = 0; i < allTiles.length; i++) {
    ...
    allTiles[i].onclick = function() {
      ...
      if (this.lastElementChild.className === "back") { // Changed This to this, and = to ===
...
function flipBack() {
  ...
  tilesFlipped = 0; // Changed titlesFlipped to tilesFlipped
}