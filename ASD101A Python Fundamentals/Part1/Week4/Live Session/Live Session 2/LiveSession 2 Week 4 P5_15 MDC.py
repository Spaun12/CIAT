...
def main():
    ...
    while True:
        try:
            bonus_rate = float(input("Enter the contribution rate for bonuses (0-20): "))
            if bonus_rate > 20 or bonus_rate < 0:
    ...
    if bonus > threshold:
        bonus_rate_high = float(input("Enter the contribution rate for high bonuses (0-20): "))
